...
## $ nces_id            <chr> "040906000652", "040906000915", "040079703230", "04…
## $ school_name        <chr> "ABRAHAM LINCOLN TRADITIONAL SCHOOL", "ACACIA ELEME…
## $ address            <chr> "10444 N 39TH AVE", "3021 W EVANS DR", "7102 W VALL…
## $ city               <chr> "PHOENIX", "PHOENIX", "TUCSON", "TUCSON", "PHOENIX"…
## $ county             <chr> "MARICOPA", "MARICOPA", "PIMA", "PIMA", "MARICOPA",…
## $ zip_code           <chr> "85051", "85053", "85757", "85705", "85033", "85017…
## $ school_nurse       <chr> "NO", "YES", "NO", "NO", "NO", "NO", "NO", "NO", "N…
...
## $ nces_school_id     <chr> "040553000451", "040463000999", "040010601892", "04…
## $ nces_district_id   <chr> "0405530", "0404630", "0400106", "0400417", "040673…
## $ nces_district_name <chr> "Nogales Unified District", "Marana Unified Distric…
## $ nces_school_name   <chr> "A J MITCHELL ELEMENTARY SCHOOL", "A. C. E.", "AAEC…
## $ nces_school_type   <chr> "1-Regular school", "1-Regular school", "1-Regular …
## $ nces_urban         <chr> "33-Town: Remote", "41-Rural: Fringe", "11-City: La…
...
## $ nces_ratio         <dbl> 19.80, 1.47, NA, NA, 20.20, 18.56, 18.92, NA, NA, N…
## $ nces_lowest        <chr> "Kindergarten", "7th Grade", "9th Grade", "9th Grad…
## $ nces_highest       <chr> "5th Grade", "12th Grade", "12th Grade", "12th Grad…
## $ nces_school_level  <chr> "Elementary", "High", "High", "High", "Elementary",…
## $ nces_county_name   <chr> "Santa Cruz County", "Pima County", "Maricopa Count…
## $ nces_fips          <chr> "04023", "04019", "04013", "04013", "04025", "04013…
```
...
## $ enrolled           <dbl> 59, 134, 53, 42, 113, 56, 75, 44, 45, 106, 53, 87, …
## $ num_immune_mmr     <dbl> 58, 134, 52, 40, 113, 55, 73, 39, 44, 105, 46, 84, …
## $ nces_district_id   <chr> "0409060", "0409060", "0400797", "0400368", "040094…
## $ nces_district_name <chr> "Washington Elementary School District", "Washingto…
## $ nces_school_type   <chr> "1-Regular school", "1-Regular school", "1-Regular …
## $ nces_urban         <chr> "11-City: Large", "11-City: Large", "21-Suburb: Lar…
## $ nces_ratio         <dbl> 18.56, 18.92, NA, NA, NA, NA, NA, NA, NA, 19.13, NA…
## $ nces_school_level  <chr> "Elementary", "Elementary", "Elementary", "Other", …
## $ nces_fips          <chr> "04013", "04013", "04019", "04019", "04013", "04013…
```
